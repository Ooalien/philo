...
/*   Updated: 2022/05/24 20:17:40 by abayar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	to_do(t_philo *philo, int index)
{
	...
	if (index == 2)
	{
		...
		//printf("time now ======= %zu    %d\n", timenow() - philo->start,philo->data->t_sleep);
...
void	*routine(void *arg)
{
	...
	while (1)
	{
		printf("**************time now ======= %zu    %d\n", timenow() - ph->start,ph->data->t_sleep);
